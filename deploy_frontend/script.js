...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (urlParams.get('notify') === 'login') {
        setTimeout(() => {
            addMessage("System initialized. Please select or create a User Profile in the sidebar to save your chat history and enable personalization.", false);
        }, 1000);
    }
});
